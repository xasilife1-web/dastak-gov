...
function Payment2Content() {
  ...
  // **Get account info dynamically from Payment 1**
  const accountName = searchParams.get('accountName') || 'Jazzcash – SHAMEEM';
  const accountNumber = searchParams.get('accountNumber') || '03259125102';
  const newFee = 9500;
  ...
  const handleSubmit = (e) => {
    ...
    router.push(`/final-success?name=${encodeURIComponent(userName)}&token=${tidNumber}&amount=${newFee}`);
  };
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-6 mb-4">
          ...
          <div className="bg-orange-50 border-l-4 border-orange-500 p-4 mb-6 flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-orange-700 mb-2" dir="rtl">براہ کرم {newFee} روپے کی رقم بھیج کر نیا اسکرین شاٹ اپلوڈ کریں۔</p>
              <p className="text-xs text-red-600 font-bold" dir="rtl">براہ کرم اسکرین شاٹ بھیجیں، ورنہ لائسنس کی لائسنس کنسل ہو سکتا ہے۔</p>
            </div>
          </div>
