          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-10 lg:gap-16 items-center">
            ...
            <section className="flex flex-col items-center gap-3 sm:gap-5 order-2 lg:order-1">
              ...
              <div className="flex flex-wrap justify-center gap-2 mt-4">
                <span className="bg-green-100 text-green-700 text-xs px-3 py-1 rounded-full font-semibold">Fast</span>
                <span className="bg-green-100 text-green-700 text-xs px-3 py-1 rounded-full font-semibold">Secure</span>
                <span className="bg-green-100 text-green-700 text-xs px-3 py-1 rounded-full font-semibold">Easy</span>
              </div>
